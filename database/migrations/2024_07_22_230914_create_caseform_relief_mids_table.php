...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('caseform_relief_mids', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('caseforms_id');
            $table->unsignedBigInteger('caseformreliefs_id');
            ...
            $table->foreign('caseformreliefs_id')->references('id')->on('caseform_reliefs')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('caseform_relief_mids');
    }
};
